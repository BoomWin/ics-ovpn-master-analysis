...
public class VpnProfile implements Serializable, Cloneable {
        ...
        switch (mAuthenticationType) {
            ...
            case VpnProfile.TYPE_CERTIFICATES:
                ...
                /*
                    ...
                    <key>
                    --------------BEGIN CERTIFICATE --------
                    asdasdasddasdsdsadasdasdadasdsdsads
                    --------------END CERTIFICATE ----------
                    </key> 이런 느낌으로 저장되는 것.
                 */
            ...
            case VpnProfile.TYPE_EXTERNAL_APP:
                if (!configForOvpn3) {
                    ...
                    if (ks != null) {
                        // mCaFilename 이 지정되어 있다면, 해당 CA 인증서를 파일에서 읽어와 설정에 추가함.
                        if (!TextUtils.isEmpty(mCaFilename)) {
                            cfg.append(insertFileData("ca", mCaFilename));
    ...
    public void writeConfigFileOutput(Context context, OutputStream out) throws IOException {
        // OutputStreamWriter 파일 이름 설정 매개변수로 받은 out
    ...
    public int checkProfile(Context context, boolean useOpenVPN3) {
        ...
        if (!mUseLegacyProvider && (dataciphers.contains("BF-CBC") || (mCompatMode > 0 && mCompatMode < 20500) && cipher.equals("BF-CBC"))) {
